			...
			<div class="text-center"> 
				...
				<form class="user" action="<?php echo base_url('Grup/update_grup');?>" method="post"> 	
					<div class="form-group"> 
						<input type="hidden" name="id" value="<?php echo $baris->id_grub; ?>"> 
						<input type="text" class="form-control form-control-user" id="nameGrup" name="nameGrup" placeholder="Change Characther.." value="<?php echo $baris->grub; ?>" require> 
					</div>
